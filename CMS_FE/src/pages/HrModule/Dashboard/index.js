...
const Dashboard = props => {
  ...
  useEffect(async () => {
    ...
    let regonapi = await fetch(`${URL}` + `/hrdetails/promotor`, {
      method: "get",
      headers: myHeaders,
    })
    let merchandapi = await fetch(`${URL}` + `/hrdetails/Merchandiser`, {
      method: "get",
      headers: myHeaders,
    })
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        {Loading && promoCount && merchandCount ? (
          <Container fluid>
            <div
                  ...
                  <div className="card-body d-flex flex-column">
                    ...
                    <div className="d-flex flex-row mb-7">
                      <div className="col-9">
                        <Link
                          to="/hradmin/promoter"
                          className="text-dark  fw-bolder fs-3"
                        >
                          Promotor{" "}
                        </Link>
                      </div>
