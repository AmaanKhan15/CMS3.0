...
const ListTable = (props) => {
    ...
    const HandleShortlist =async (id) => {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Short Listed Sucessfully!',
                                                ...
                                                .map((item, key) => {
                                                    return (
                                                        <tr key={key}>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="#" class="text-muted fw-normal font-size-14">{item.full_name}</a>
                                                                        {/* <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span> */}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.location}</a>
                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                            </td>
                                                            <td>
                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.profile_tag}</a>
                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                            </td>
                                                            <td>

                                                                <span class="text-muted fw-bold text-muted d-block fs-7">{item.qualification}</span>
                                                            </td>

                                                            <td>
                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.college}</a>
                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                            </td>
                                                            <td >
                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.key_skill}</a>
                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                            </td>
                                                            <td >
                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.mobile_no}</a>
                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                            </td>

                                                            <td>
                                                                <div class="d-flex justify-content-end ">
                                                                    <a href={`https://cmsapi.connect-mscom.com/assets/Hr/` + item.resume} target="_blank" class="btn btn-bg-light-warning btn-active-color-warning btn-lg">
                                                                        Resume
                                                                    </a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex justify-content-end ">
                                                                <a onClick={() => HandleShortlist(item.id)} class="btn btn-bg-light-danger btn-active-color-danger btn-lg">
                                                                        Finalize 
                                                                    </a>
                                                                </div>                                                               
                                                            </td>
