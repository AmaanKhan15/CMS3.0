...
console.log("auth data is",data)
	useEffect(async () => {
		...
		setApidata(response)
		console.log("dashborad card dat is",response)
				...
				{Loading && apidata ? (<Container fluid>
					...
					<Container fluid>
						...
						<Row >
								...
								<div className="card card-xxl-stretch mb-5 mb-xl-8 btn-rounded" style={{ "backgroundColor": "#FFF3B5" }}>
									<div className="card-body d-flex flex-column">
										...
										<div className="d-flex flex-row mb-7">
											...
											<div className="col-3">
												<a href="#" className="text-dark  fw-bolder fs-3"> {apidata.Total_Promotor}</a>
											</div>
										...
										<div className="row g-0">
											<div className="col-6">
												<div className="d-flex align-items-center mb-9 me-2">
													...
													<div>
														<div className="fs-7 text-gray-600 fw-bold">Daily Report</div>
													</div>
												</div>
											</div>
											<div className="col-6">
												<div className="d-flex align-items-center mb-9 ms-2">
													...
													<div>
														<div className="fs-7 text-gray-600 fw-bold">Weekly Report</div>
													</div>
												</div>
											</div>
											<div className="col-6">
												<div className="d-flex align-items-center me-2">
													...
													<div>
														...
														<div className="fs-7 text-gray-600 fw-bold">Monthly Report</div>
													</div>
													{/*end::Title */}
												</div>
											</div>
											...
											<div className="col-6">
												<div className="d-flex align-items-center ms-2">
													...
													<div>
														...
														<div className="fs-7 text-gray-600 fw-bold">Yearly Report</div>
													</div>
													{/*end::Title */}
												</div>
											</div>
								...
								<div className="card card-xxl-stretch mb-5 mb-xl-8 btn-rounded" style={{ "backgroundColor": "#FFB2B2" }}>
									<div className="card-body d-flex flex-column">
										...
										<div className="d-flex flex-row mb-7">
											...
											<div className="col-3">
												<a href="#" className="text-dark  fw-bolder fs-3"> {apidata.Total_Merchand}</a>
											</div>
							...
							<Col xl={4} md={6}>
								<div className="card card-xxl-stretch mb-5 mb-xl-8 btn-rounded" style={{ "backgroundColor": "#ACF8EF" }}>
									<div className="card-body d-flex flex-column">
										<div className="d-flex flex-row mb-7">
											<div className="col-9">
												<a href="#" className="text-dark  fw-bolder fs-3">Stores </a>
											</div>
											<div className="col-3">
												<a href="#" className="text-dark  fw-bolder fs-3"> {apidata.Total_Stores}</a>
											</div>
										</div>
										<div className="row g-0">
											{/*begin::Col */}
