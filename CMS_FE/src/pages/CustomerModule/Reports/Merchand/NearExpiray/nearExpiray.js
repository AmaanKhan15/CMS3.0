...
import { getNearExpiray,getStoreList,getStoreGroupList,getCityList } from "../../../../../store/services/allmerchandReports"
...
const Dashboard = props => {
    ...
    const handleSelectStore = async (selectedStore) => {
        ...
        let categoryList = await getNearExpiray(selectedStore.value);
