...
const ListIndex = (props) => {
    ...
    useEffect(async () => {
        ...
        let res = await fetch(
            `${URL}`+`/customermodule/unavailableSKU`,
            {
                method: "POST",
                headers: myHeaders,
                body: Bodydata
                ...
                <Container fluid={true}>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col md={8}>
                                <h6 className="page-title">Unavailable SKU List <p>(SKU Qty Less Than 15 In Warehouse)</p></h6>
                            </Col>
                        </Row>
                    </div>
                                                    ...
                                                    return (
                                                        <tr key={key}>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        {/* <a href="#" class="text-muted fw-normal font-size-14">{`${item.sku_detail!=='null'?item.sku_detail['sku'] +" "+  item.sku_detail['sku_desc']:'null'}`}</a> */}
                                                                        <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail!=null?item.sku_detail['sku'] +" "+  item.sku_detail['sku_desc']:''}</a>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="#" class="text-muted fw-normal font-size-14">{item.qty_warehouse}</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                {/* <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail['category']}</a> */}
