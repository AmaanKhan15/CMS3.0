...
import { getAllMacSeries } from "../../../../../store/services/AppleStore/filtersdata"
...
const BarGraph =()=>{
  ...
  const [loader,setloader]=useState(false);
   useEffect(async ()=>{    
        let  merList= await getAllMacSeries(monthdata,yeardata,regiondata);        
   ...
   const onChangeLoader=async (data)=>{
    ...
    setloader(data)
    let  merList= await getAllMacSeries(monthdata,yeardata,regiondata); 
    console.log("updated list id",merList)       
    console.log("updated list id",monthdata)       
    console.log("updated list id",yeardata)       
    console.log("updated list id",regiondata)       
    setseriesdata(merList)  
    if(merList){
      setloader(false)
    }
