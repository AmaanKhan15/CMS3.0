...
const Dashboard = props => {
	...
	useEffect(async () => {
		...
		let regonapi = await fetch(
			`${URL}`+`/customermodule/regionReport`,
			{
				method: "post",
				headers: myHeaders,
				body: Bodydata
	...
	return (
		<React.Fragment>
			<div className="page-content">
				...
				{Loading && apidata ? (<Container fluid>
					<div
									...
									<div className={classes.root}>
										...
										<AppBar position="static" style={{ background: '#306060' }}>
											...
											>
												...
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={AppleMac} />}   {...a11yProps(1)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={IPhone} />}   {...a11yProps(2)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={Ipad} />}   {...a11yProps(3)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={AirPods} />}   {...a11yProps(4)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={AppleTv} />}   {...a11yProps(5)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={AppleCare} />}   {...a11yProps(6)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={IpodIcon} />}   {...a11yProps(7)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={AppleWatchIcon} />}   {...a11yProps(8)} />
												<Tab icon={<img alt="TrophyShining" style={{ 'width': '30px', 'height': '30px' }} src={Accessories} />}   {...a11yProps(9)} />
											</Tabs>
										</AppBar>
													...
													<Card>
														<CardBody>
															<div class="card-title">
																<div class="d-flex justify-content-start">
																	<Col md={6}>
																		<h3 class="m-0 text-gray-900">Apple Care+</h3>
																	</Col>
																</div>
															</div>
															<AppleCareComp />
													...
													<Card>
														<CardBody>
															<div class="card-title">
																<div class="d-flex justify-content-start">
																	<Col md={6}>
																		<h3 class="m-0 text-gray-900">Accessories</h3>
																	</Col>
																</div>
															</div>
															<AccessoriesComp />
													...
													<Card>
														<CardBody>
															<div class="card-title">
																<div class="d-flex justify-content-start">
																	<Col md={6}>
																		<h3 class="m-0 text-gray-900">Region Report</h3>
																	</Col>
																</div>
															</div>
															<RegionData RegionData={regiondata} SalesData={salesdata} />
														</CardBody>
													</Card>
												</Col>
