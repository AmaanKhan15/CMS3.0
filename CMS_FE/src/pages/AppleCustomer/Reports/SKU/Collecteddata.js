...
const ListIndex = (props) => {
    ...
    useEffect(async () => {
        ...
        let res = await fetch(
            `${URL}`+`/customermodule/libraryofcollectedData`,
            {
                method: "POST",
                headers: myHeaders,
                body: Bodydata
        ...
        const empResult = response.Submitted_Data;
                ...
                <Container fluid={true}>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col md={12}>
                                <h6 className="page-title">Collected Data</h6>
                            </Col>
                        </Row>
                    </div>
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    <thead>
                                        <tr class="text-muted fw-normal font-size-15">
                                            ...
                                            <th class="min-w-120px">Total Sales Qty</th>                                            
                                                ...
                                                .map((item, key) => {
                                                    return (
                                                        <tr key={key}>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="#" class="text-muted fw-normal font-size-14">{`${item.sku_detail['sku']}` +" "+ `${item.sku_detail['sku_desc']}`}</a>
                                                            ...
                                                            <td>
                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail['product_name']}</a>
                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                            </td>
                                                            ...
                                                            {/* <td>
                                                            <img src={`https://muyoni.in/cms/`+`${item.image1}`} alt="No Image" />
                                                            </td>                                                            
                                                            <td>
                                                            <img src={`https://muyoni.in/cms/`+`${item.image2}`} alt="No Image"/>                                                            
                                                            </td>                                                             */}
                                                        </tr>)
                                                }) :
                                            apidata
                                                ...
                                                .map((item, key) => {
                                                    return (
                                                        <tr key={key}>
                                                            ...
                                                            {/* <td>
                                                            <img src={item.image1} alt="No Image" />
                                                            </td>                                                            
                                                            <td>
                                                            <img src={item.image2} alt="No Image"/>                                                            
                                                            </td>                                                             */}
                                                        </tr>)
                                            })
                                        }
