                                                ...
                                                .map((item, key) => {                                                
                                                    return (   
                                                        <tr key={key}>                                                                                                                                                                                                                            
                                                            ...
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.move_in_product_exp_date}</a>
                                                            </td>  
                                                            <td>
