...
const Dashboard = props => {
    ...
    const FilterChange = async () => {
        ...
        let merchandrepoList = await getDailyMerchandRepo(selectedMerchand.value,selectedStore.value,selectedCategory.label);
        setreportData(merchandrepoList)  
        console.log("merchandiser details ",merchandrepoList)
    }
                                    ...
                                    <CardBody >
                                        <div class="card-title">
                                            <div class="d-flex justify-content-end">
                                                <Col md={6}>
                                                    <h3 class="m-0 text-gray-900">Merchandiser Daily Report</h3>
                                                </Col>
                                                <Col md={4}></Col>
                                                <Col md={2}>
                                                </Col>
