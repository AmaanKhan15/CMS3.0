...
import { getCityList,getCategoryCitySales ,getProductCitySales,getSKUCitySales,getPromCompare} from "../../../../../store/services/CitySales"
import DateRangePicker from '@wojtekmaj/react-daterange-picker';
import { getPromotorByCustomerId } from "../../../../../store/services/PromotorReport"
import SalesTable from "./promoCompareTable"
import SalesBar from "./promoCompareBar"
const Dashboard = props => {
    ...
    const handleSelectSKU = async (selectedSKU) => {
        ...
        let skuReport = await getPromCompare(data.id,selectedSKU.value,selectedPromo);
                                    ...
                                    <CardBody >
                                        <div class="card-title">
                                            <div class="d-flex justify-content-end">
                                                <Col md={6}>
                                                    <h3 class="m-0 text-gray-900">Promotor Comapare Report</h3>
                                                </Col>
                                                <Col md={4}></Col>
                                                <Col md={2}>
                                                </Col>
