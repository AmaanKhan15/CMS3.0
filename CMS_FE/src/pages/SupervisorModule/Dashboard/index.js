...
const Dashboard = props => {
  ...
  useEffect(async () => {
    ...
    let res = await fetch(`${URL}` + `/supervisormodule/dashboard`, {
      method: "post",
      headers: myHeaders,
      body: Bodydata,
    })
        ...
        {Loading && apidata ? (
          ...
          <Container fluid>
            ...
            <Row>
              <Col xl={6} md={6}>
                <div
                  className="card card-xxl-stretch mb-5 mb-xl-8 btn-rounded"
