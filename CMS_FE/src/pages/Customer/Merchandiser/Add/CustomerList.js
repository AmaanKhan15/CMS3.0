            ...
            <Row>
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <input type="text" class="form-control form-control-lg form-control-solid w-750px btn-rounded-small" placeholder="Search Customers" />
                        <button
                            type="button"
                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-14">Customer Name</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bolder fs-14">Customer Name</a>
                                        </td>
                                        <td>
                ...
                {openModal?(<SuccessModal isOpen={openModal} TabOpen={onChangeState} message={"Customer"}/>):(null)}
            </Row>
