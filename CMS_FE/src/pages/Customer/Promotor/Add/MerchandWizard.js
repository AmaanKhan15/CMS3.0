...
import AddStoreForm from "./AddPromotor";
import UploadStoreForm from "./UploadPromotor";
                ...
                <Container fluid={true}>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col md={8}>
                                <h6 className="page-title">Promoter</h6>
                            </Col>
                        </Row>
                    </div>
					...
					<div class="stepper stepper-links" id="kt_create_account_stepper">
						...
						<div class="stepper-nav ">
							...
							<div className={`stepper-item  ${activeTab === 1 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 12.0rem',cursor: 'pointer'} }>
								<h3 class="stepper-title" onClick={() => {toggleTab(1) }}>Add Promoter</h3>
							</div>
							<div className={`stepper-item  ${activeTab === 2 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 12.0rem',cursor: 'pointer'} } >
								<h3 class="stepper-title" onClick={() => {toggleTab(2)}} >Upload Promoter</h3>
							</div>
							{/* <div className={`stepper-item  ${activeTab === 3 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 5.0rem',cursor: 'pointer'} } >
								<h3 class="stepper-title" onClick={() => {toggleTab(3)}} >Add Customer</h3>
							</div>
							<div className={`stepper-item  ${activeTab === 4 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 5.0rem',cursor: 'pointer'} } >
