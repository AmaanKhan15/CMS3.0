...
const UploadStoreForm = (props) => {
    ...
    const handleSubmitPersosnal = async (e) => {
        ...
        const response = await fetch(`${URL}`+`/promotor/bulk_upload_store`, {
            method: 'POST',
            headers: {
...
console.log("response from server is",responseData)
        ...
        if (responseData.status == 200) {
            ...
            Swal.fire({
            icon: 'success',
            title: 'Promoter Added Succesfully',
