...
const Dashboard = props => {
  ...
  useEffect(async () => {
    ...
    let res = await fetch(`${URL}` + `/merchandmodule/singlemerchandReport`, {
      method: "post",
      headers: myHeaders,
      body: Bodydata,
    })
                    ...
                    <div class="card card-xl-stretch mb-xl-8 btn-rounded">
                      <div class="card-body d-flex align-items-center pt-3 pb-0">
                        <img
                          src={image3}
                          alt=""
                          class="align-self-center h-150px mb-20"
                        />

                        <div class="d-flex flex-column flex-grow-0-5  py-2 py-lg-13 me-2">
                          <a
                            href="#"
                            class="fw-bolder text-dark fs-2 mb-2 text-hover-primary"
                          >
                            {location.state.merchand}
                          </a>
