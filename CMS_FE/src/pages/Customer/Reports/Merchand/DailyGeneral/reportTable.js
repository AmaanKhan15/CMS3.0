                                                ...
                                                .map((item, key) => {                                                
                                                    return (   
                                                        <tr key={key}>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                         <a href="#" class="text-muted fw-normal font-size-14">{item.merchand_detail!=null ? `${item.merchand_detail['FullName']}`:''}</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.store_detail!=null ? `${item.store_detail['city']}`:''}</a>
                                                            </td>                                                                                                      
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail!=null ? `${item.sku_detail['product_name']}`:''}</a>
                                                            </td>                                                                                                      
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail!=null ? `${item.sku_detail['category']}`:''}</a>
                                                            </td>                                                                                                      
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail!=null ? `${item.sku_detail['shelf_qty']}`:''}</a>
                                                            </td>                                                                                                      
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail!=null ? `${item.sku_detail['no_of_shelf']}`:''}</a>
                                                            </td>                                                                                                      
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.sku_detail!=null ? `${item.sku_detail['shelf_space']}`:''}</a>
                                                            </td>                                                                                                      
                                                            <td>
                                                            ...
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.move_in_qty}</a>
                                                            </td>                                                                                                      
                                                            <td>
                                                            <a href="#" class="text-muted fw-normal font-size-14">{item.move_out_qty}</a>
                                                            </td>                                                                                                      
                                                        </tr>                                                        
                                                    )                                                  
                                                }) :
