...
import { getDamageStock,getStoreList,getStoreGroupList,getCityList } from "../../../../../store/services/allmerchandReports"
...
const Dashboard = props => {
    ...
    const FilterChange = async () => {
        ...
        setfilterCount(0)  
        let categoryList = await getDamageStock(selectedStore.value,selectedCity.label,formatDate(value[0]),formatDate(value[1]));        
                                    ...
                                    <CardBody >
                                        <div class="card-title">
                                            <div class="d-flex justify-content-end">
                                                <Col md={6}>
                                                    <h3 class="m-0 text-gray-900">Damaged Stock Report</h3>
                                                </Col>
                                                <Col md={4}></Col>
                                                <Col md={2}>
                                                </Col>
