...
import { getDamageStock,getStoreList,getNearExpiray,getCityList } from "../../../../../store/services/allmerchandReports"
...
const Dashboard = props => {
    ...
    const FilterChange = async () => {
        ...
        let categoryList = await getNearExpiray(selectedStore.value,selectedCity.label,formatDate(value[0]),formatDate(value[1]));
                                    ...
                                    <CardBody >
                                        <div class="card-title">
                                            <div class="d-flex justify-content-end">
                                                <Col md={6}>
                                                <h3 class="m-0 text-gray-900">Near Expiray Report</h3>
                                                </Col>
                                                <Col md={4}></Col>
                                                <Col md={2}>
                                                </Col>
