...
import { getCityList,getCategoryCitySales ,getProductCitySales,getSKUCitySales,getAllStore,getAllPromotor,getPromotorSalesAmt} from "../../../../store/services/CitySales"
...
const Dashboard = props => {
    ...
    const handleSelectSKU = async (selectedSKU) => {
        ...
        console.log("from promotor amt ",selectedSKU.value,selectedPromo.value)
        let promotorReport=await getPromotorSalesAmt(selectedSKU.value,selectedPromo.value);
       setreportData(promotorReport);
                                    ...
                                    <CardBody >
                                        <div class="card-title">
                                            <div class="d-flex justify-content-end">
                                                <Col md={6}>
                                                    <h3 class="m-0 text-gray-900">Promoter Sales Amt Report</h3>
                                                </Col>
                                                <Col md={4}></Col>
                                                <Col md={2}>
                                                </Col>
