...
import { getCityList,getCategoryCitySales ,getProductCitySales,getSKUCitySales,getStoreByCustomer,getAllPromotor,getAllStore} from "../../../../store/services/CitySales"
import DateRangePicker from '@wojtekmaj/react-daterange-picker';
import { getPromotorByCustomerId } from "../../../../store/services/PromotorReport"
import DashCard from "./PromoterDaily/DashCards"
...
const Dashboard = props => {
    ...
    const handleSelectSKU = async (selectedSKU) => {
        ...
        let promotorReport=await getFilterReport(selectedStore.value,selectedSKU.value,selectedPromo.value);
       setreportData(promotorReport);
                                    ...
                                    <CardBody >
                                        <div class="card-title">
                                            <div class="d-flex justify-content-end">
                                                <Col md={6}>
                                                    <h3 class="m-0 text-gray-900">Promoter Performance Report</h3>
                                                </Col>
                                                <Col md={4}></Col>
                                                <Col md={2}>
                                                </Col>
