...
import { getCityList,getCategoryCitySales ,getProductCitySales,getSKUCitySales,getStoreCompare,getAllStore,getStoreCompareWithoutCustomer} from "../../../../store/services/CitySales"
...
const Dashboard = props => {
    ...
    const handleSelectSKU = async (selectedSKU) => {
        ...
        let skuReport = await getStoreCompareWithoutCustomer(selectedSKU.value,selectedPromo);
