...
import { LoginReportPromotor } from "../../../../store/services/allmerchandReports"
...
const ListIndex = (props) => {
    ...
    useEffect(async () => {
        let merchandrepoList = await LoginReportPromotor(props.merchand,props.store,props.startdate,props.enddate);
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="d-flex justify-content-start flex-column">
                                                                     <a href="#" class="text-muted fw-normal font-size-14">{item.promotor_detail!=null ?`${item.promotor_detail['first_name']}`:''}</a>
                                                ...
                                                .map((item, key) => {
                                                    return (
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="d-flex justify-content-start flex-column">
                                                                     <a href="#" class="text-muted fw-normal font-size-14">{item.promotor_detail!=null ?`${item.promotor_detail['first_name']}` +" "+ `${item.promotor_detail['last_name']}`:''}</a>
                                                                    {/* <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span> */}
                                                                </div>
                                                            </div>
                                                        </td>
