				...
				<CardBody>
					<div class="stepper stepper-links" id="kt_create_account_stepper">
						...
						<div class="stepper-nav ">
							{/*begin::Step 1*/}
							<div className={`stepper-item  ${activeTab === 1 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 9.0rem',cursor: 'pointer'} }>
								<h3 class="stepper-title" onClick={() => {toggleTab(1) }}>Add Store</h3>
							</div>
							<div className={`stepper-item  ${activeTab === 2 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 9.0rem',cursor: 'pointer'} } >
								<h3 class="stepper-title" onClick={() => {toggleTab(2)}} >Upload Store</h3>
							</div>
							<div className={`stepper-item  ${activeTab === 3 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 9.0rem',cursor: 'pointer'} } >
								<h3 class="stepper-title" onClick={() => {toggleTab(3)}} >Store List</h3>
							</div>
							{/* <div className={`stepper-item  ${activeTab === 4 ? "current" : ""}`} data-kt-stepper-element="nav" style={{'margin': '1rem 6.0rem',cursor: 'pointer'} } >
