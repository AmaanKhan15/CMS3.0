...
const AddStoreForm = (props) => {
    ...
    const handleSubmitPersosnal = async (e,storeid) => {
        ...
        if (document.getElementById("storeName").value != "" && document.getElementById("contactNo").value != "" && document.getElementById("Regno").value != "" && document.getElementById("address").value != "" && document.getElementById("area").value != "" && document.getElementById("lati").value != "" && document.getElementById("long").value != "") {
            setLoading(true);
            let data = await updateStore(document.getElementById("storeName").value, document.getElementById("contactNo").value, document.getElementById("Regno").value, document.getElementById("address").value, document.getElementById("area").value, document.getElementById("lati").value, document.getElementById("long").value,storeid);
