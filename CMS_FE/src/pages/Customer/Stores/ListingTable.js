                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                <Link type="button" to="/store-add" class="btn btn-primary font-size-14" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Stores</Link>
                            </div>
                                                ...
                                                .map((item, key) => {
                                                    return (
                                                        <tr key={key}>
                                                            ...
                                                            <td >
                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.customer_detail==null?'Not Assigned':item.customer_detail['company_name']}</a>
                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                            </td>
