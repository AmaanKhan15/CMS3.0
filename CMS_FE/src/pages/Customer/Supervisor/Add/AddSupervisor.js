...
import { postSupervisor } from '../../../../store/services/supervisor'
...
const AddStoreForm = (props) => {
  ...
  const handleSubmitPersosnal=async(e)=> {
    ...
    if(document.getElementById("fName").value!= ""  &&document.getElementById("mName").value!= ""  && document.getElementById("lName").value!= ""  && document.getElementById("contactNo").value!= ""  &&  document.getElementById("address").value!= ""  && document.getElementById("area").value!= "" && document.getElementById("email").value!= "" && document.getElementById("proofno").value!= ""&& document.getElementById("city").value!= ""){
     ...
     let data=await postSupervisor(fname,mname,lname,email,address,area,poorf_no,city,selectedProof,selectedGroup,contact,username,password)     
     setTimeout(() => {
       setLoading(false);
     }, 2000);
        if(data.status==200){
  ...
  props.Tabdata(2); 
    ...
    return (
        <Form className="needs-validation"
            ...
            <Row>
                <div class="w-100">
                    <div class="pb-10 pb-lg-15">
                        <h2 class="fw-bolder text-dark">Add Supervisor For   
            ...
            {openModal?(<SuccessModal isOpen={openModal} TabOpen={onChangeState} message={"Supervisor"}/>):(null)}
            <Row>
            <div class="w-100">
                <div className="row mb-5">
                <div className="col-md-6 fv-row">
