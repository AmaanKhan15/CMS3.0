...
import storeSample from "../../../../assets/Files/promotordemo.xlsx"
...
const UploadStoreForm = (props) => {
    ...
    const handleSubmitPersosnal = async (e) => {
        ...
        const response = await fetch(`${URL}`+`/bulk_upload_supervisor`, {
            method: 'POST',
            headers: {
        ...
        if (responseData.status == 200) {
            ...
            Swal.fire({
            icon: 'success',
            title: 'Supervisor Added Succesfully',
