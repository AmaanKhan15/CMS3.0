...
const AddStoreForm = props => {
  ...
  const handleSubmitPersosnal = async (e, id) => {
    ...
    if (
      ...
      document.getElementById("proofno").value != "" &&
      ...
      let data = await updateSupervisor(
        fname,
        mname,
        lname,
        email,
  ...
  useEffect(async () => {
    ...
    let res = await fetch(`${URL}` + `/supervisor/` + `${location.state.id}`, {
      method: "get",
      headers: myHeaders,
    })
                            ...
                            <div class="w-100">
                              <div class="pb-10 pb-lg-15">
                                ...
                                <div class="text-muted fw-bold fs-6">
                                  Please Enter Details to Add Supervisor.
                                </div>
                              </div>
