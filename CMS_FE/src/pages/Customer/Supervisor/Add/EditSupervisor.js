...
import { updateSupervisor } from '../../../../store/services/supervisor'
...
const AddStoreForm = (props) => {
  ...
  const handleSubmitPersosnal=async(e,id)=> {
    ...
    if(document.getElementById("fName").value!= ""  &&document.getElementById("mName").value!= ""  && document.getElementById("lName").value!= ""  && document.getElementById("contactNo").value!= ""  &&  document.getElementById("address").value!= ""  && document.getElementById("area").value!= "" && document.getElementById("email").value!= "" && document.getElementById("proofno").value!= ""&& document.getElementById("city").value!= ""){
     ...
     let data=await updateSupervisor(fname,mname,lname,email,address,area,poorf_no,city,selectedProof,selectedGroup,contact,username,password,id)     
     setTimeout(() => {
       setLoading(false);
     }, 2000);
        if(data.status==200){
        ...
        Swal.fire({
            icon: 'success',
            title: 'Supervisor Updated Sucessfully!',
...
useEffect(async()=>{
// console.log("data is",location.state.id)
var myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
  let res = await fetch(
    `${URL}`+`/supervisor/`+`${location.state.id}`,
    {
      method: "get",
      headers: myHeaders,
    }
                ...
                <Container fluid={true}>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col md={8}>
                                <h6 className="page-title">Supervisor</h6>
                            </Col>
                        </Row>
                    </div>
            ...
            <Row>
                <div class="w-100">
                    <div class="pb-10 pb-lg-15">
                        <h2 class="fw-bolder text-dark">Edit Supervisor    
                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Adding Marchands"></i>	</h2>														
						<div class="text-muted fw-bold fs-6">Please Enter Details to Add Supervisor.</div>                      
                    </div>
...
<div
            ...
            <div class="w-100">
                ...
                <div className="col-md-6 fv-row">
                        ...
                        <div className="col-md-6 fv-row">
                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                <span className="required">Proof No</span>
                            </label>
                            <div className="mb-3 position-relative">
                            <Input
                            type="text"
