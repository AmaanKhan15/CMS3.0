          ...
          <div className="col-md-6 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                id="sku"
                placeholder="SKU"
                onChange={event => changeHandeler(event, "sku1")}
              />

              <div
                className={sku === false ? "invalid-tooltip" : ""}
                name="validate"
                id="sku1"
              >
                {sku === false ? "Please Enter Sku" : ""}
              </div>
            </div>
          ...
          <div className="col-md-6 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                onChange={event => changeHandeler(event, "cartonQty1")}
              />

              <div
                className={carqty === false ? "invalid-tooltip" : ""}
                name="validate"
                id="cartonQty1"
              >
                {carqty === false ? "Carton Qty is Required" : ""}
              </div>
            </div>
            {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
          </div>
          <div className="col-md-6 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                onChange={event => changeHandeler(event, "Refno1")}
              />

              <div
                className={refno === false ? "invalid-tooltip" : ""}
                name="validate"
                id="Refno1"
              >
                {refno === false ? "Refernce No is Required" : ""}
              </div>
            </div>
            {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
          </div>
          ...
          <div className="col-md-12 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                onChange={event => changeHandeler(event, "skuDesc1")}
              />

              <div
                className={skudec === false ? "invalid-tooltip" : ""}
                name="validate"
                id="skuDesc1"
              >
                {skudec === false ? "SKU Description is Required" : ""}
              </div>
            </div>
            {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
          </div>
          ...
          <div className="col-md-6 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                onChange={event => changeHandeler(event, "category1")}
              />

              <div
                className={catgy === false ? "invalid-tooltip" : ""}
                name="validate"
                id="category1"
              >
                {catgy === false ? "Category is Required" : ""}
              </div>
            </div>
            {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
          </div>
          ...
          <div className="col-md-6 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                onChange={event => changeHandeler(event, "productname1")}
              />

              <div
                className={proname === false ? "invalid-tooltip" : ""}
                name="validate"
                id="productname1"
              >
                {proname === false ? "Product name is Required" : ""}
              </div>
            </div>
            {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
          </div>
          ...
          <div className="col-md-6 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                onChange={event => changeHandeler(event, "productdesc1")}
              />

              <div
                className={prodesc === false ? "invalid-tooltip" : ""}
                name="validate"
                id="productdesc1"
              >
                {prodesc === false ? "Product Description is Required" : ""}
              </div>
            </div>
            {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
          </div>
          ...
          <div className="col-md-6 fv-row">
            ...
            <div className="mb-3 position-relative">
              <Input
                ...
                onChange={event => changeHandeler(event, "productprice1")}
              />

              <div
                className={proprice === false ? "invalid-tooltip" : ""}
                name="validate"
                id="productprice1"
              >
                {proprice === false ? "Product Price is Required" : ""}
              </div>
            </div>
            {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
          </div>
