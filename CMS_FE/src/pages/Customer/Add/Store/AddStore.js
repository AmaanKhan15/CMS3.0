            ...
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  onChange={event => changeHandeler(event, "storeName1")}
                />
                <div
                  className={storeName === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="storeName1"
                >
                  {storeName === false ? "Store Name is Required" : ""}
                </div>
              </div>
            ...
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  onChange={event => changeHandeler(event, "Regno1")}
                />
                <div
                  className={Regno === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="Regno1"
                >
                  {Regno === false ? "Registeration No is Required" : ""}
                </div>
              </div>
              {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
            </div>
            ...
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  onChange={event => changeHandeler(event, "contactNo1")}
                />
                <div
                  className={contactNo === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="contactNo1"
                >
                  {contactNo === false ? "Contact No is Required" : ""}
                </div>
              </div>
              {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
            </div>
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  id="area"
                  placeholder="Area"
                  onChange={event => changeHandeler(event, "area1")}
                />

                <div
                  className={area === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="area1"
                >
            ...
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  onChange={event => changeHandeler(event, "lati1")}
                />
                <div
                  className={lati === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="lati1"
                >
                  {lati === false ? "Latitude is Required" : ""}
                </div>
              </div>
              {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
            </div>
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  onChange={event => changeHandeler(event, "long1")}
                />
                <div
                  className={long === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="long1"
                >
                  {long === false ? "longitude is Required" : ""}
                </div>
              </div>
              {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
            </div>
            ...
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  id="address"
                  placeholder="Address"
                  onChange={event => changeHandeler(event, "address1")}
                />
                <div
                  className={address === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="address1"
                >
                  {address === false ? "Address is Required" : ""}
                </div>
              </div>
              {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
            </div>
            <div className="col-md-6 fv-row">
              ...
              <div className="mb-3 position-relative">
                <Input
                  ...
                  id="city"
                  placeholder="City"
                  onChange={event => changeHandeler(event, "city1")}
                />
                <div
                  className={city === false ? "invalid-tooltip" : ""}
                  name="validate"
                  id="city1"
                >
                  {city === false ? "Address is Required" : ""}
                </div>
              </div>
              {/* <input type="text" class="form-control form-control-lg " placeholder="First Name" name="first-name" /> */}
            </div>
