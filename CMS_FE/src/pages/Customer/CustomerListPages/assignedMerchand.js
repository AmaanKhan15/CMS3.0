...
const ListIndex = (props) => {
    ...
    useEffect(async () => {
        ...
        console.log("location id is",stateId)
        var myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json");
        let res = await fetch(
            `${URL}`+`/merchandbycustomer/` + `${stateId}`,
            {
                method: "GET",
                headers: myHeaders,
            }
        ...
        console.log("data from assigned merchand is",empResult)
        setLoading(false);
        setTimeout(() => {
            setLoading(false);
        }, 5000);
    ...
    Swal.fire({
            icon: 'success',
            title: `Merchandiser Removed Succesfully`,
                ...
                <Container fluid={true}>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col md={8}>
                                <h6 className="page-title">Assigned Merchandiser </h6>
                            </Col>
                            <Col md={3}>
                            </Col>
                            <Col md={1}>
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-toolbar">
                                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                <a type="button"  onClick={()=>{history.push({pathname:'/unassignedmerchand/list',state:{stateId}})}} class="btn btn-primary font-size-14" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Assign New Merchandiser </a>
                                            </div>
                                        </div>
                                        {/*end::Card toolbar*/}
                                    </div>
                                                ...
                                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                                    <thead>
                                                        <tr class="text-muted fw-normal font-size-15">
                                                            ...
                                                            <th class="min-w-120px">Store Group Name</th>
                                                                ...
                                                                .map((item, key) => {
                                                                    return (
                                                                        <tr key={key}>
                                                                            ...
                                                                            <td >
                                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.storegroup_detail == null?('Not Assigned'):item.storegroup_detail['store_group_name']}</a>
                                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                                            </td>
                                                                            <td>
                                                                                <div class="d-flex justify-content-end ">
                                                                                    <a onClick={() => HandleDelete(item.id,item.username)} class="btn btn-bg-light-danger btn-active-color-danger btn-lg">
                                                                                        Remove
                                                                                    </a>
                                                                                </div>
                                                                            </td>
