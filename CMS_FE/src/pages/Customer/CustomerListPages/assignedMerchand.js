...
const ListIndex = props => {
  ...
  useEffect(async () => {
    ...
    let res = await fetch(`${URL}` + `/merchandbycustomer/` + `${stateId}`, {
      method: "GET",
      headers: myHeaders,
    })
                    ...
                    <div class="card-toolbar">
                      ...
                      >
                        <a
                          ...
                          onClick={() => {
                            history.push({
                              pathname: "/unassignedmerchand/list",
                              state: { stateId },
                            })
                          }}
                          class="btn btn-primary font-size-14"
                                      ...
                                      <tr key={key}>
                                        ...
                                        <td>
                                          <a
                                            ...
                                            class="text-muted fw-normal font-size-14"
                                          >
                                            {item.storegroup_detail == null
                                              ? "Not Assigned"
                                              : item.storegroup_detail[
                                                  "store_group_name"
                                                ]}
                                          </a>
                                          {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                        ...
                                        <td>
                                          <div class="d-flex justify-content-end ">
                                            <a
                                              ...
                                              class="btn btn-bg-light-danger btn-active-color-danger btn-lg"
                                            >
                                              Remove
                                            </a>
                                          </div>
