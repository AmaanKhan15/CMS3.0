...
const ListIndex = (props) => {
    ...
    console.log("location id is",location.state.id)
        ...
        let res = await fetch(
            `${URL}`+`/promotorbyCustomerId/` + `${location.state.id}`,
                ...
                <Container fluid={true}>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col md={8}>
                                <h6 className="page-title">Assigned Promoters </h6>
                            </Col>
                            <Col md={3}>
                            </Col>
                            <Col md={1}>
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-toolbar">
                                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                <a type="button"  onClick={()=>{history.push({pathname:'/unassignedpromotor/list',state:{id:stateId}})}} class="btn btn-primary font-size-14" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Assign New Promoter</a>
                                            </div>
                                        </div>
                                        {/*end::Card toolbar*/}
                                    </div>
                                                                ...
                                                                .map((item, key) => {
                                                                    return (
                                                                        <tr key={key}>
                                                                            ...
                                                                            <td >
                                                                                <a href="#" class="text-muted fw-normal font-size-14">{item.store_detail==null?('Not Assigned'):item.store_detail['store_name']}</a>
                                                                                {/* <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> */}
                                                                            </td>
                                                                            <td>
