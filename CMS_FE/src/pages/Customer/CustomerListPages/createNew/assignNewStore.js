...
import { getUnAssignedStores, postStoreUpdate } from "../../../../store/services/store"
...
const UploadStoreForm = (props) => {
    ...
    const HandleGroupPop = () => {
        ...
        let data = postStoreUpdate(selectedStore, location.state.id)
        ...
        if(data.status==200){
            Swal.fire({
                    icon: 'success',
                    title: 'Stores Assigned Succesfully',
                                                ...
                                                <Row>
                                                    ...
                                                    <div class="card-toolbar">
                                                        <div class="d-flex justify-content-center" data-kt-customer-table-toolbar="base">
                                                            <Link type="button" to="/store-add" class="btn btn-primary font-size-14" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add New Stores</Link>
                                                        </div>
                                                    </div>
                                                </Container>}
                                                </Row>
