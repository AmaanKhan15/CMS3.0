...
const Promotortarget = (props) => {
    ...
    useEffect(async () => {
        let skuList = await getSKUList(location.state.custId, location.state.storeId);
        console.log("data is", skuList)
        skuList.map((item, key) => {
            skulist.push({ label: item.product_name + " " + item.product_desc, value: item.id })
        })
        setLoading(true);
        setTimeout(() => {
            setLoading(false);
    ...
    const handleSubmitPersosnal = async (e) => {
        ...
        if (document.getElementById("target").value != "" && document.getElementById("tdescript").value != "") {
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div className="row mb-5">
                                                        <div className="col-md-12 fv-row">
                                                            <label class="text-muted fw-normal font-size-15">
                                                                <span className="required">Target Description</span>
                                                            </label>
                                                            <div className="mb-3 position-relative">
                                                                <Input
                                                                    type="text"
