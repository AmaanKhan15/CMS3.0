...
const UploadStoreForm = (props) => {
    ...
    const HandleGroupPop = () => {
        ...
        let data = postPromotorUpdate(selectedStore, location.state.id)
        ...
        if(data.status==200){
            Swal.fire({
                    icon: 'success',
                    title: 'Promoter Assigned Succesfully',
                                                ...
                                                <Row>
                                                    ...
                                                    <div class="card-toolbar">
                                                        <div class="d-flex justify-content-center" data-kt-customer-table-toolbar="base">
                                                            <Link type="button" to="/promotor-add" class="btn btn-primary font-size-14" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add New Promoter</Link>
                                                        </div>
                                                    </div>
                                                </Container>}
                                                </Row>
