                    ...
                    <div class="card card-xl-stretch mb-xl-8 btn-rounded">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            ...
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="#" class="fw-bolder text-dark fs-4 mb-2 text-hover-primary">{item.first_name + " "+item.last_name }</a>
                                <span class="fw-bold text-muted fs-5 mb-2">{item.customer_detail == null?'':item.customer_detail['company_name']}</span>
                                ...
                                <div className="mb-30">
                                    ...
                                    <span class="fw-bold fs-6 text-600">{item.store_detail == null?'':item.store_detail['store_name']}</span>
