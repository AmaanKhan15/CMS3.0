...
const dummyhelperCardData = [
    {
        id  : 1,
        link1 : 'customer', count1 : "--",
        link2 : 'store', count2 : "--",
        year : "--"
    },
    {
        id  : 2,
        link1 : 'promotor', count1 : "--",
        link2 : 'merchandiser', count2 : "--",
        year : "--"
    },
]
        ...
        setHelperCardData([
            {
                ...
                link2 : 'store', count2 : data.stores.total_by_current_year,
                year : new Date().getFullYear()
            },
            {
                id  : 2,
                link1 : 'promotor', count1 : data.promoters.total_by_current_year,
                name1 : 'promoters',
                link2 : 'merchandiser', count2 : data.merchands.total_by_current_year,
                year : new Date().getFullYear()
...
const Card = ({bg,border,color,name,img,count = 0,link : _link}) => {
    ...
    return  <div className="m-card"  style = {{
        backgroundColor : bg,
        borderColor : border,
    }}>
    ...
    {/* todo : navigate on buttons */}
        <div className="c-btn"
        onClick = {()=>history.push(link+'-list')}
        >See All</div>
        <div className="c-btn"
        onClick = {()=>history.push(link+'-add')}
        >Add New +</div>
    </div>
</div>
}
...
const HelperCard = ({link1 = "",link2 = "",count1,count2,year}) => {
    ...
    return <div className="helper-m-card">
        <p>{link1} arrised by {count1} count in current year ({year})</p>
        <p>{link2} arrised by {count2} count in current year ({year})</p>
        <br />
        ...
        {/* todo : navigate on buttons */}
        <div className="c-btn"
        onClick = {()=>history.push(link1+'-list')}
        
        >See {link1}s</div>
          <div className="c-btn"
        onClick = {()=>history.push(link2+'-list')}
    ...
    <div className="trending-list">
        ...
        <div className="trending-list-item" key = {index}>
            ...
            <div className="t-info">
                <p className='t-name'>{li.first_name} <span>| {li.city}</span> </p> 
