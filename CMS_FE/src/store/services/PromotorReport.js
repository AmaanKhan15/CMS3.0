...
//custid for this api  
export const getFilterReport = async (storid,skuid,promoid,startdate,enddate,custid) => {
  ...
  let res = await fetch(
    `${URL}`+`/customermodule/promotorReport` ,
    {
      method: "POST",
      headers: myHeaders,
      body: Bodydata
...
export const getFilterReportWithoutCustomer = async (custid,storid,skuid,promoid) => {
