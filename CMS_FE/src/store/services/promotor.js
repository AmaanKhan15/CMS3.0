...
export const getUnAssignedPromotors = async id => {
  ...
  myHeaders.append("Content-Type", "application/json")
  myHeaders.append("Cache-Control", "no-cache")
  let res = await fetch(`${URL}` + `/Unassignedpromotor`, {
    method: "GET",
    headers: myHeaders,
  })
  let response = await res.json()
...
export const promotorByUsersup = async (merchandids, id) => {
  ...
  merId.map(async (item, key) => {
    ...
    let res = await fetch(`${URL}` + `/promotorByUsersup/` + `${item.id}`, {
      method: "put",
      headers: myHeaders,
      body: Bodydata,
    })
...
export const postUpdateStoresPromotor = async (merchanddata, storegroupid) => {
  ...
  merchanddata.map(async (item, key) => {
    ...
    let res = await fetch(`${URL}` + `/promotorByStoregroup/` + `${item.id}`, {
      method: "put",
      headers: myHeaders,
      body: Bodydata,
    })
...
export const postPromotor = async (
  fname,
  mname,
  lname,
  email,
...
export const updatePromotor = async (
  fname,
  mname,
  lname,
  email,
  ...
  let res = await fetch(`${URL}` + `/promotor/` + `${id}`, {
    method: "put",
    headers: myHeaders,
    body: Bodydata,
  })
...
export const postPromotorUpdate = async (promomtor, id) => {
  ...
  promomtor.map(async (item, key) => {
    ...
    let res = await fetch(`${URL}` + `/promotor/` + `${item.id}`, {
      method: "put",
      headers: myHeaders,
      body: Bodydata,
    })
