...
export const postMerchandiser = async (fname,mname,lname,email,address,area,poorf_no,city,selectedProof,selectedGroup,contact,username,password) => { 
  var myHeaders = new Headers();
  console.log("data is",fname,mname,lname,email,address,area,poorf_no,city,selectedProof,selectedGroup,contact)
  myHeaders.append("Content-Type", "application/json");
...
export const updateMerchandiser = async (fname,mname,lname,email,address,area,poorf_no,city,selectedProof,selectedGroup,contact,username,password,merchid) => { 
  var myHeaders = new Headers();
  console.log("data is",fname,mname,lname,email,address,area,poorf_no,city,selectedProof.value,selectedGroup.value,contact,username,password,merchid)
  myHeaders.append("Content-Type", "application/json");
  var Bodydata = JSON.stringify({
    first_name: fname,
    middle_name: mname,
...
export const postUpdateStoresMerchand=async(merchanddata,storegroupid,custid)=>{
  var myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
  ...
  let res = await fetch(
    `${URL}` + `/merchandByStoregroup/`+`${item.id}`,
    {
      method: "put",
      headers: myHeaders,
      body: Bodydata
