...
export const postSupervisor = async (fname,mname,lname,email,address,area,poorf_no,city,selectedProof,selectedGroup,contact,username,password) => { 
  var myHeaders = new Headers();
...
export const updateSupervisor = async (fname,mname,lname,email,address,area,poorf_no,city,selectedProof,selectedGroup,contact,username,password,id) => { 
  var myHeaders = new Headers();
  console.log("data is",fname,mname,lname,email,address,area,poorf_no,city,selectedProof.value,selectedGroup.value,contact)
  myHeaders.append("Content-Type", "application/json");
  var Bodydata = JSON.stringify({
...
export const updateSupervisorById = async (superid,custid) => {    
  ...
  let res = await fetch(
    `${URL}` + `/promotorBySupervisorId/`+`${superid}`,
    {
      method: "put",
      headers: myHeaders,
      body: Bodydata
...
export const updateSupervisorByIdMerchand = async (superid,custid) => {    
  ...
  let res = await fetch(
    `${URL}` + `/merchandBySupervisor/`+`${superid}`,
    {
      method: "put",
      headers: myHeaders,
      body: Bodydata
