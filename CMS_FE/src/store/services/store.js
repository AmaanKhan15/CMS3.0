...
export const postStoreData = async (stname,refno,contno,area,address,lat,long, customerId,city) => {
  var myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
...
export const updateStore=async(stname,contno,refno,address,area,lat,long,id)=>{
