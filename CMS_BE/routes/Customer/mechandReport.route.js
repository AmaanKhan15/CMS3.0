...
//   router.post('/customermodule/Merchand',MerchandController.postMerchandRecords);
  ...
  router.post('/customermodule/allStoreIds',merchandController.getAllStoreId);
  ...
  router.post('/customermodule/visiblityReport',merchandController.getVisiblityMerchandRepoWithSKU);
  router.post('/customermodule/salesReport',merchandController.getMerchandSalesReport);


  //Unavialble Stock
  router.post('/customermodule/unavialableStock',merchandController.getUnavialableStock);
