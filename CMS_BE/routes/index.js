...
const HRModule=require('./hrdetails.route');
const Salesman=require('./salesman.route');
const SalesmanLogin=require("./SalesmanApp/login.route");
const AssignedSalesmanstore=require("./SalesmanApp/assignedstore.route");
const AppleCustomer =require("./AppleCustomer/allFilter.route")
const AppleReportCustomer =require("./AppleCustomer/generateReport.route")
const AppleRoute=require("./PromotorApp/appleapi.route");
const ComparisonApi=require("./PromotorApp/comparison.route")
...
module.exports =(router) =>{        
    ...
    HRModule(router);
    Salesman(router);
    SalesmanLogin(router);
    AssignedSalesmanstore(router);
    AppleCustomer(router);
    AppleReportCustomer(router);
    AppleRoute(router);
    ComparisonApi(router)
